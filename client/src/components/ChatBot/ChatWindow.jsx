...
export default function ChatWindow({ onClose }) {
  ...
  return (
    <div className="w-[calc(100vw-3rem)] max-md:h-[50vh] h-[70vh] max-w-[280px] sm:w-80 sm:h-[420px] sm:max-w-none bg-white rounded-2xl shadow-2xl flex flex-col transition-all duration-300 border border-gray-200 backdrop-blur-sm chat-mobile-compact">
      {/* Header */}
